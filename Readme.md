...
- Detect duplicate SQL queries and oversized result sets to catch SELECT N+1 issues and missing filters, [see more here](Lombiq.Tests.UI/Docs/SqlQueryMonitoring.md).
