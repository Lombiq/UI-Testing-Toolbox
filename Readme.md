...
- Testing time-dependent functionalities with a time shifting clock, and testing a headless app with a separate frontend. See a demo video [here](https://www.youtube.com/watch?v=eK2C9BW98sM).
