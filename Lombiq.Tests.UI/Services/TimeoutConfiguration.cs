...
namespace Lombiq.Tests.UI.Services
{
    public class TimeoutConfiguration
    {
        ...
        /// this is included in <see cref="RetryTimeout"/>. Defaults to 500ms.
        /// </summary>
        /// <example>
        ...
        /// of an app (i.e. app start), running the Orchard setup and importing large recipes. Defaults to 180s.
        /// </summary>
