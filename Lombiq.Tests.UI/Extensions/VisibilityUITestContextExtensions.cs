...
namespace Lombiq.Tests.UI.Extensions
{
    public static class VisibilityUITestContextExtensions
    {
        ...
        /// they're revealed like this. Once interactions with these elements are done it's good practice to revert
        /// this change with <see cref="RevertAdminCheckboxesVisibility(UITestContext)"/>.
        /// </summary>
