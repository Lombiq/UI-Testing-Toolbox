...
{
    /// <summary>
    /// Make the native checkboxes visible on the admin so they can be selected and Selenium operations can work on them
    /// as usual. This is necessary because the Orchard admin theme uses custom controls which hide the native
