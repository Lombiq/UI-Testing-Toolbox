...
- The browsers that you can use (Chrome, Edge, and Firefox) will be automatically installed by [Selenium Manager](https://www.selenium.dev/documentation/selenium_manager/).
