...
- Visual verification is implemented using [ImageSharpCompare](https://github.com/Codeuctivity/ImageSharp.Compare/blob/2.0.46/README.md).
- [Ben.Demystifier](https://github.com/benaadams/Ben.Demystifier) used to simplify stack trace, mainly around async methods.
