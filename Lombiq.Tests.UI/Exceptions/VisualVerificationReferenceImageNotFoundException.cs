...
{
    public VisualVerificationReferenceImageNotFoundException(string path)
        : this(path, innerException: null)
    {
    }

    public VisualVerificationReferenceImageNotFoundException(string path, Exception innerException)
        : base(
