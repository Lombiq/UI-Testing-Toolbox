...
public class MonkeyTests : UITestBase
{
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser0(Browser browser) =>
        ExecuteTestAfterSetupAsync(
            async context =>
            {
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser1(Browser browser) =>
        ExecuteTestAfterSetupAsync(
            async context =>
            {
                var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser2(Browser browser) =>
        ExecuteTestAfterSetupAsync(
            async context =>
            {
                var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser3(Browser browser) =>
        ExecuteTestAfterSetupAsync(
            async context =>
            {
                var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser4(Browser browser) =>
        ExecuteTestAfterSetupAsync(
            async context =>
            {
                var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser10(Browser browser) =>
    ExecuteTestAfterSetupAsync(
        async context =>
        {
            var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser11(Browser browser) =>
        ExecuteTestAfterSetupAsync(
            async context =>
            {
                var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser12(Browser browser) =>
        ExecuteTestAfterSetupAsync(
            async context =>
            {
                var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser13(Browser browser) =>
        ExecuteTestAfterSetupAsync(
            async context =>
            {
                var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser14(Browser browser) =>
        ExecuteTestAfterSetupAsync(
            async context =>
            {
                var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser20(Browser browser) =>
    ExecuteTestAfterSetupAsync(
        async context =>
        {
            var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser21(Browser browser) =>
        ExecuteTestAfterSetupAsync(
            async context =>
            {
                var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser22(Browser browser) =>
        ExecuteTestAfterSetupAsync(
            async context =>
            {
                var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser23(Browser browser) =>
        ExecuteTestAfterSetupAsync(
            async context =>
            {
                var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser24(Browser browser) =>
        ExecuteTestAfterSetupAsync(
            async context =>
            {
                var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser30(Browser browser) =>
    ExecuteTestAfterSetupAsync(
        async context =>
        {
            var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser31(Browser browser) =>
        ExecuteTestAfterSetupAsync(
            async context =>
            {
                var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser32(Browser browser) =>
        ExecuteTestAfterSetupAsync(
            async context =>
            {
                var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser33(Browser browser) =>
        ExecuteTestAfterSetupAsync(
            async context =>
            {
                var monkeyTestingOptions = CreateMonkeyTestingOptions();
    ...
    [Theory, Chrome]
    public Task TestAdminBackgroundTasksAsMonkeyRecursivelyShouldWorkWithAdminUser34(Browser browser) =>
        ExecuteTestAfterSetupAsync(
            async context =>
            {
                var monkeyTestingOptions = CreateMonkeyTestingOptions();
